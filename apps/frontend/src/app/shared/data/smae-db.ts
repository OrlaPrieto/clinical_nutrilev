...
export const SMAE_DATABASE: SmaeFood[] = [
  // ==================== 🥦 VERDURAS ====================
  { name: 'Calabacita picada', category: 'Verduras', emoji: '🥒', equivalentPortion: '1/2 taza (70g)', amountValue: 0.5, unit: 'taza', calories: 25, protein: 2, carbs: 4, fat: 0, tip: 'Ideal al vapor, asada o en caldos.', gramsEquivalent: 70 },
  { name: 'Brócoli cocido', category: 'Verduras', emoji: '🥦', equivalentPortion: '1 taza (90g)', amountValue: 1, unit: 'taza', calories: 25, protein: 2, carbs: 4, fat: 0, tip: 'Excelente fuente de fibra y antioxidantes.', gramsEquivalent: 90 },
  { name: 'Zanahoria picada o rallada', category: 'Verduras', emoji: '🥕', equivalentPortion: '1/2 taza (60g)', amountValue: 0.5, unit: 'taza', calories: 25, protein: 2, carbs: 4, fat: 0, tip: 'Aporta betacarotenos excelentes para la vista.', gramsEquivalent: 60 },
  { name: 'Espinaca cruda', category: 'Verduras', emoji: '🥬', equivalentPortion: '2 tazas (60g)', amountValue: 2, unit: 'tazas', calories: 25, protein: 2, carbs: 4, fat: 0, tip: 'Ideal para ensaladas o licuados verdes.', gramsEquivalent: 60 },
  { name: 'Espinaca cocida', category: 'Verduras', emoji: '🥬', equivalentPortion: '1/2 taza (95g)', amountValue: 0.5, unit: 'taza', calories: 25, protein: 2, carbs: 4, fat: 0, tip: 'Se reduce mucho al cocer, aporta hierro no hemo.', gramsEquivalent: 95 },
  ...
  { name: 'Pepino rebanado', category: 'Verduras', emoji: '🥒', equivalentPortion: '1 taza (100g)', amountValue: 1, unit: 'taza', calories: 25, protein: 2, carbs: 4, fat: 0, tip: 'Muy hidratante y saciante, ideal para colaciones.', gramsEquivalent: 100 },
  { name: 'Nopal cocido', category: 'Verduras', emoji: '🌵', equivalentPortion: '1 taza (130g)', amountValue: 1, unit: 'taza', calories: 25, protein: 2, carbs: 4, fat: 0, tip: 'Excelente aporte de fibra soluble que ayuda a controlar la glucosa.', gramsEquivalent: 130 },
  { name: 'Champiñón cocido', category: 'Verduras', emoji: '🍄', equivalentPortion: '1 taza (70g)', amountValue: 1, unit: 'taza', calories: 25, protein: 2, carbs: 4, fat: 0, tip: 'Ideal para acompañar quesadillas o guisados.', gramsEquivalent: 70 },
  { name: 'Cebolla picada', category: 'Verduras', emoji: '🧅', equivalentPortion: '1/2 taza (50g)', amountValue: 0.5, unit: 'taza', calories: 25, protein: 2, carbs: 4, fat: 0, tip: 'Añade gran sabor con un aporte mínimo de calorías.', gramsEquivalent: 50 },
  { name: 'Lechuga (todas las variedades)', category: 'Verduras', emoji: '🥬', equivalentPortion: '2 tazas (90g)', amountValue: 2, unit: 'tazas', calories: 25, protein: 2, carbs: 4, fat: 0, tip: 'Ideal para dar volumen y saciedad a tus platos.', gramsEquivalent: 90 },
  { name: 'Ejotes cocidos', category: 'Verduras', emoji: '🌱', equivalentPortion: '1 taza (100g)', amountValue: 1, unit: 'taza', calories: 25, protein: 2, carbs: 4, fat: 0, tip: 'Combínalos con huevo o pollo.', gramsEquivalent: 100 },
  { name: 'Flor de calabaza', category: 'Verduras', emoji: '🌸', equivalentPortion: '1 taza (100g)', amountValue: 1, unit: 'taza', calories: 25, protein: 2, carbs: 4, fat: 0, tip: 'Poco aporte calórico, ideal en quesadillas de panela.', gramsEquivalent: 100 },
  { name: 'Apio crudo picado', category: 'Verduras', emoji: '🌿', equivalentPortion: '1.5 tazas (150g)', amountValue: 1.5, unit: 'tazas', calories: 25, protein: 2, carbs: 4, fat: 0, tip: 'Súper crujiente, ideal para calmar la ansiedad.', gramsEquivalent: 150 },
  ...
  { name: 'Fresas enteras', category: 'Frutas', emoji: '🍓', equivalentPortion: '1 taza (150g)', amountValue: 1, unit: 'taza', calories: 60, protein: 0, carbs: 15, fat: 0, tip: 'Muy pocas calorías por volumen. Desinféctalas bien.', gramsEquivalent: 150 },
  { name: 'Melón picado', category: 'Frutas', emoji: '🍈', equivalentPortion: '1 taza (160g)', amountValue: 1, unit: 'taza', calories: 60, protein: 0, carbs: 15, fat: 0, tip: 'Muy rico en agua e ideal para mantenerte hidratado.', gramsEquivalent: 160 },
  { name: 'Papaya picada', category: 'Frutas', emoji: '🥭', equivalentPortion: '3/4 taza (140g)', amountValue: 0.75, unit: 'taza', calories: 60, protein: 0, carbs: 15, fat: 0, tip: 'Excelente para la digestión por su enzima papaína.', gramsEquivalent: 140 },
  ...
  { name: 'Mango picado', category: 'Frutas', emoji: '🥭', equivalentPortion: '1/2 taza (80g)', amountValue: 0.5, unit: 'taza', calories: 60, protein: 0, carbs: 15, fat: 0, tip: 'Rico en vitaminas A y C.', gramsEquivalent: 80 },
  ...
  { name: 'Piña picada', category: 'Frutas', emoji: '🍍', equivalentPortion: '3/4 taza (120g)', amountValue: 0.75, unit: 'taza', calories: 60, protein: 0, carbs: 15, fat: 0, tip: 'Contiene bromelina, que ayuda a la digestión de proteínas.', gramsEquivalent: 120 },
  ...
  { name: 'Avena cruda en hojuelas', category: 'Cereales sin grasa', emoji: '🌾', equivalentPortion: '1/4 taza (20g)', amountValue: 0.25, unit: 'taza', calories: 70, protein: 2, carbs: 15, fat: 0, tip: 'Rica en betaglucanos que ayudan a reducir el colesterol.', gramsEquivalent: 20 },
  { name: 'Avena cocida en agua', category: 'Cereales sin grasa', emoji: '🥣', equivalentPortion: '1/3 taza (80g)', amountValue: 0.33, unit: 'taza', calories: 70, protein: 2, carbs: 15, fat: 0, tip: 'Al cocerse en agua duplica su tamaño y aumenta la saciedad.', gramsEquivalent: 80 },
  { name: 'Arroz blanco o integral cocido', category: 'Cereales sin grasa', emoji: '🍚', equivalentPortion: '1/4 taza (50g)', amountValue: 0.25, unit: 'taza', calories: 70, protein: 2, carbs: 15, fat: 0, tip: 'Cocínalo al vapor con sal de mar, cebolla y ajo.', gramsEquivalent: 50 },
  { name: 'Pasta cocida (spaghetti, pluma, etc.)', category: 'Cereales sin grasa', emoji: '🍝', equivalentPortion: '1/3 taza (50g)', amountValue: 0.33, unit: 'taza', calories: 70, protein: 2, carbs: 15, fat: 0, tip: 'Cocínala "al dente" para reducir su índice glucémico.', gramsEquivalent: 50 },
  ...
  { name: 'Amaranto natural tostado', category: 'Cereales sin grasa', emoji: '🌾', equivalentPortion: '1/4 taza (15g)', amountValue: 0.25, unit: 'taza', calories: 70, protein: 2, carbs: 15, fat: 0, tip: 'Excelente fuente de proteína vegetal de alta calidad.', gramsEquivalent: 15 },
  ...
  { name: 'Elote desgranado cocido', category: 'Cereales sin grasa', emoji: '🌽', equivalentPortion: '1/2 taza (80g)', amountValue: 0.5, unit: 'taza', calories: 70, protein: 2, carbs: 15, fat: 0, tip: 'Aporte dulce y rico en fibra.', gramsEquivalent: 80 },

  // ==================== 🫘 LEGUMINOSAS ====================
  { name: 'Frijoles cocidos de la olla', category: 'Leguminosas', emoji: '🫘', equivalentPortion: '1/2 taza (120g)', amountValue: 0.5, unit: 'taza', calories: 120, protein: 8, carbs: 20, fat: 1, tip: 'Excelente fuente de hierro y fibra. Prefiérelos sin freír.', gramsEquivalent: 120 },
  { name: 'Lentejas cocidas', category: 'Leguminosas', emoji: '🍲', equivalentPortion: '1/2 taza (120g)', amountValue: 0.5, unit: 'taza', calories: 120, protein: 8, carbs: 20, fat: 1, tip: 'Gran aporte de folatos, perfectas en sopa con verduras.', gramsEquivalent: 120 },
  { name: 'Garbanzos cocidos', category: 'Leguminosas', emoji: '🧆', equivalentPortion: '1/2 taza (120g)', amountValue: 0.5, unit: 'taza', calories: 120, protein: 8, carbs: 20, fat: 1, tip: 'Ideales para ensaladas o triturados como hummus.', gramsEquivalent: 120 },
  { name: 'Habas cocidas', category: 'Leguminosas', emoji: '🍲', equivalentPortion: '1/2 taza (120g)', amountValue: 0.5, unit: 'taza', calories: 120, protein: 8, carbs: 20, fat: 1, tip: 'Tradicionales y muy nutritivas.', gramsEquivalent: 120 },
  ...
  { name: 'Queso Cottage bajo en grasa', category: 'AOA bajo en grasa', emoji: '🥛', equivalentPortion: '1/4 taza (50g)', amountValue: 0.25, unit: 'taza', calories: 55, protein: 7, carbs: 1, fat: 2, tip: 'Excelente opción untable o para ensaladas dulces.', gramsEquivalent: 50 },
  ...
  // ==================== 🥛 LÁCTEOS ====================
  { name: 'Yogurt griego natural sin azúcar', category: 'Lácteos descremados', emoji: '🥛', equivalentPortion: '1/2 taza (125g)', amountValue: 125, unit: 'gramos', calories: 95, protein: 9, carbs: 12, fat: 2, tip: 'Alto en proteína. Elige marcas sin edulcorantes artificiales.', gramsEquivalent: 125 },
  { name: 'Leche descremada (Light)', category: 'Lácteos descremados', emoji: '🥛', equivalentPortion: '1 taza (240g)', amountValue: 1, unit: 'taza', calories: 95, protein: 9, carbs: 12, fat: 1, tip: 'Mismos nutrientes que la leche entera sin la grasa saturada.', gramsEquivalent: 240 },
  { name: 'Leche entera clásica', category: 'Lácteos enteros', emoji: '🥛', equivalentPortion: '1 taza (240g)', amountValue: 1, unit: 'taza', calories: 150, protein: 9, carbs: 12, fat: 8, tip: 'Ideal para niños en crecimiento o pacientes en volumen.', gramsEquivalent: 240 },
  { name: 'Yogurt natural entero sin azúcar', category: 'Lácteos enteros', emoji: '🥛', equivalentPortion: '1/2 taza (120g)', amountValue: 0.5, unit: 'taza', calories: 150, protein: 9, carbs: 12, fat: 8, tip: 'Textura cremosa y aporte balanceado.', gramsEquivalent: 120 },
